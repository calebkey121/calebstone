...
class Player:
    def __init__(self, heroName, deckList):
        ...
        self._gold = PLAYER_STARTING_GOLD
        self._maxGold = PLAYER_MAX_GOLD
        self._income = PLAYER_STARTING_INCOME
    ...
    def get_hero_status(self):
        return {
            "name": self._hero.name(),
            "attack": self._hero.attack(),
            "health": self._hero.health()
        }
    def get_army_status(self):
        return [ { "name": ally._name, "attack": ally._attack, "health": ally._health, "cost": ally._cost } for ally in self._army ]
    ...
    def out_of_cards(self):
        return self._deck.get_current_num_cards <= 0
    ...
    def available_targets(self): # attackable allies
        ...
        for idx, ally in self._army.get_army():
    ...
    def hero_ready_up(self):
        self._hero.ready_up()

    def hero_ready_down(self):
        self._hero.ready_down()
